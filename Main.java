...
public class Main {
    ...
    static String oracleUserName = "bdreyer"; // replace with your uniqname
    static String password = "Ihbpfjstmneyne02"; // replace with your Oracle password (default: eecsclass)
